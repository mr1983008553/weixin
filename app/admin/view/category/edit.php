        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$oldData['cname']}}" name="cname" placeholder="请输入栏目名称">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">排序</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{$oldData['orders']}}" name="orders" placeholder="请输入栏目名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label>
                                <input type="radio" name="is_cate" value="1" <if value="$oldData['is_cate']==1">checked</if> >是
                            </label>
                            <label>
                                <input type="radio" name="is_cate" value="2" <if value="$oldData['is_cate']==2">checked</if>>否
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <select name="pid"  class="form-control">
                            ...
                            <foreach from="$cateData" key="$k" value="$v">
                                <option value="{{$v['id']}}" <if value="$oldData['pid']==$v['id']">selected</if> >  {!!$v['_cname']!!}  </option>
                            </foreach>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input class="form-control" name="thumb" readonly="" value="{{$oldData['thumb']}}">
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            ...
                            <img src="{{pic($oldData['thumb'],'/node_modules/hdjs/dist/static/image/nopic.jpg')}}" class="img-responsive img-thumbnail" width="150">
